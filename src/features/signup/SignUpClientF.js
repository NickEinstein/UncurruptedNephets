      ...
      <div className="flex justify-between">
        <div className="w-1/2 px-40 py-20 text-center">
          <div className="flex-vertical">
            ...
            <Typography variant="h6" className="mb-16 bold">
              Enter Information
            </Typography>
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <p
                className="m-b-20"
                style={{ fontSize: "7px", margin: "5px", textAlign: "left" }}
              >
                Make it catchy, this will be displayed to your employer
              </p>
              <TextField
                type="password"
                name="password"
              ...
              <p className="nine-size my-10 w-full">
                By pressing “Create account”, you agree to our{" "}
                <a className="nine-size bold">Terms & Conditions</a>
              </p>
            ...
            <a href="">
              <h2 className="medium-size m-t-20">
